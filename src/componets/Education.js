    ...
    return (
        <div className="education--container">
            <div className="education--one">
                ...
                <div className="education--year"><span className="passedout--year">2021 - 2022</span></div>
            </div>
            <div className="education--one">
                <div className="education--name">
                ...
                <div className="education--year"><span className="passedout--year">2015 - 2020</span></div>
            </div>
            <div className="education--one">
                <div className="education--name">
                ...
                <div className="education--year"><span className="passedout--year">2010 - 2015</span></div>
            </div>
        </div>
    )
}