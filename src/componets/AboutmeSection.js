            ...
            <div className="about--me--header ">
                ...
                <div className="about--me--box shadow-lg">
                    <div className="col-lg-6 col-md-6 col-sm-12 box--left">
                        <lottie-player src="https://assets1.lottiefiles.com/private_files/lf30_Twfrj1.json"  background="transparent"  speed="1"  style={{width: "500px", height: "500px"}}  loop autoplay ></lottie-player>
                    </div>
